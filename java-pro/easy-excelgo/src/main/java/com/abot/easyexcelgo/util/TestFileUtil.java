package com.abot.easyexcelgo.util;
...
public class TestFileUtil {
    ...
    public static String getPath() {
        URL resource = TestFileUtil.class.getResource("/");
        URL resource2 = TestFileUtil.class.getResource("");
        URL resource3 = User.class.getResource("/");
        URL resource4 = User.class.getResource("");
